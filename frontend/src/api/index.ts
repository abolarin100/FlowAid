...
export const paymentsApi = {
  ...
  getByCampaign: (campaignId: string, page = 0, size = 25) =>
    apiClient
      .get<
        Page<Payment>
      >(`/payments/campaign/${campaignId}`, { params: { page, size } })
      .then((r) => r.data),
...
export const recipientsApi = {
  list: (page = 0, size = 25) =>
    apiClient
      .get<Page<Recipient>>("/recipients", { params: { page, size } })
      .then((r) => r.data),
  ...
  updateStatus: (id: string, status: string) =>
    apiClient
      .patch<Recipient>(`/recipients/${id}/status`, { status })
      .then((r) => r.data),
};
...
export const donorsApi = {
  list: (page = 0, size = 25) =>
    apiClient
      .get<Page<Donor>>("/donors", { params: { page, size } })
      .then((r) => r.data),
